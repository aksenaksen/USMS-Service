package io.aksenaksen.demo.usms.store.constant;
...
public class StoreConstants {
    ...
    public static final String BUSINESS_LICENSE_IMG_KEY_REGEX = "^[0-9a-fA-F]{8}[0-9a-fA-F]{4}4[0-9a-fA-F]{3}[89abAB][0-9a-fA-F]{3}[0-9a-fA-F]{12}\\.[a-z]+$";
