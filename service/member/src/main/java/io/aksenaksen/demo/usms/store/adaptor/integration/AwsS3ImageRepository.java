...
import static io.aksenaksen.demo.usms.config.CacheConfiguration.IMG_FILE_CACHE_KEY;
...
public class AwsS3ImageRepository implements ImageRepository {
    ...
    @CachePut(value = IMG_FILE_CACHE_KEY, key = "#key", cacheManager = "cacheManager")
    @Override
    ...
    @Cacheable(value = IMG_FILE_CACHE_KEY, key =  "#key", cacheManager = "cacheManager")
    @Override
